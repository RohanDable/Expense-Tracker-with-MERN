      ...
      <div className="lg:flex justify-around mt-5 lg:mt-32">
        <div className="mx-auto mt-5 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/yash-nathe-7055a2210/"
                target="blank"
              >
                {" "}
              ...
              <a
                href="https://www.instagram.com/mr._a_a_s_h_u_36/?igshid=ZmRlMzRkMDU%3D"
                target="blank"
              >
                {" "}
                <img src={instagram} alt="instagram" className="h-8 w-8" />
              </a>
              <a href="https://github.com/yashnathe" target="blank">
                {" "}
        ...
        <div className="mx-auto mt-5 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/rohan-dable-276957219"
                target="blank"
              >
                {" "}
                <img src={linkedin} alt="linkdein" className="h-8 w-8" />
              ...
              <a
                href="https://instagram.com/rohan_dable2026?igshid=Yzg5MTU1MDY="
                target="blank"
              >
                {" "}
                <img src={instagram} alt="linkdein" className="h-8 w-8" />
              </a>
              <a href="https://github.com/RohanDable" target="blank">
                {" "}
                <img src={github} alt="github" className="h-8 w-8" />
              </a>
            </div>
        ...
        <div className="mx-auto mt-5 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/aniket-nikumbh-420bb1226"
                target="blank"
              >
                {" "}
                <img src={linkedin} alt="linkdein" className="h-8 w-8" />
              ...
              <a
                href="https://instagram.com/aniiikettttt?igshid=NzMyMjgxZWIzNw=="
                target="blank"
              >
                {" "}
                <img src={instagram} alt="linkdein" className="h-8 w-8" />
              </a>
              <a href="https://github.com/Aniikettt" target="blank">
                {" "}
                <img src={github} alt="github" className="h-8 w-8" />
              </a>
            </div>
        ...
        <div className="mx-auto my-5 lg:mb-0 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/mayuri-gaikwad-971a19253"
                target="blank"
              >
                {" "}
                <img src={linkedin} alt="linkdein" className="h-8 w-8" />
              </a>
              <a href="https://instagram.com/_.mayuuu.10._?igshid=ZDdkNTZiNTM=" target="blank">
                {" "}
                <img src={instagram} alt="instagram" className="h-8 w-8" />
              </a>
              <a href="https://github.com/Artificilux" target="blank">
                {" "}
                <img src={github} alt="github" className="h-8 w-8" />
              </a>
            </div>
